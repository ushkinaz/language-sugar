  ...
  <root id="7730107903695361516">
    ...
    <node role="constructor" roleId="tpee.1068390468201" type="tpee.ConstructorDeclaration" typeId="tpee.1068580123140" id="7730107903695361518">
      ...
      <node role="body" roleId="tpee.1068580123135" type="tpee.StatementList" typeId="tpee.1068580123136" id="7730107903695361521">
        ...
        <node role="statement" roleId="tpee.1068581517665" type="atci.UnlessInlineStatement" typeId="atci.4998957681465435837" id="4998957681465440094">
          <node role="condition" roleId="atci.1068580123160" type="tpee.DotExpression" typeId="tpee.1197027756228" id="4998957681465440098">
            <node role="operand" roleId="tpee.1197027771414" type="tpee.LocalVariableReference" typeId="tpee.1068581242866" id="4998957681465440097">
              <link role="variableDeclaration" roleId="tpee.1068581517664" targetNodeId="7730107903695361523" resolveInfo="intro" />
            </node>
            <node role="operation" roleId="tpee.1197027833540" type="tpee.IsEmptyOperation" typeId="tpee.1225271369338" id="4998957681465440102" />
          </node>
          <node role="inlineExpression" roleId="atci.1082485599094" type="tpee.DotExpression" typeId="tpee.1197027756228" id="7730107903695475602">
        ...
        <node role="statement" roleId="tpee.1068581517665" type="tpee.Statement" typeId="tpee.1068580123157" id="4998957681465451691" />
        <node role="statement" roleId="tpee.1068581517665" type="tpee.SingleLineComment" typeId="tpee.6329021646629104954" id="4998957681465451693">
          <node role="commentPart" roleId="tpee.6329021646629175155" type="tpee.TextCommentPart" typeId="tpee.6329021646629104957" id="4998957681465451694">
            <property name="text" nameId="tpee.6329021646629104958" value="&quot;if&quot; statement" />
          </node>
        </node>
        <node role="statement" roleId="tpee.1068581517665" type="atci.IfInlineStatement" typeId="atci.4998957681465435841" id="4998957681465451683">
          <node role="condition" roleId="atci.1068580123160" type="tpee.GreaterThanExpression" typeId="tpee.1081506762703" id="4998957681465451687">
            <node role="rightExpression" roleId="tpee.1081773367579" type="tpee.IntegerConstant" typeId="tpee.1068580320020" id="4998957681465451690">
              <property name="value" nameId="tpee.1068580320021" value="20" />
            </node>
            <node role="leftExpression" roleId="tpee.1081773367580" type="tpee.LocalVariableReference" typeId="tpee.1068581242866" id="4998957681465451686">
              <link role="variableDeclaration" roleId="tpee.1068581517664" targetNodeId="6100386288364165602" resolveInfo="age" />
            </node>
          </node>
          <node role="inlineExpression" roleId="atci.1082485599094" type="tpee.DotExpression" typeId="tpee.1197027756228" id="4998957681465451678">
            <node role="operand" roleId="tpee.1197027771414" type="tpee.StaticFieldReference" typeId="tpee.1070533707846" id="4998957681465451679">
              <link role="classifier" roleId="tpee.1144433057691" targetNodeId="e2lb.~System" resolveInfo="System" />
              <link role="variableDeclaration" roleId="tpee.1068581517664" targetNodeId="e2lb.~System%dout" resolveInfo="out" />
            </node>
            <node role="operation" roleId="tpee.1197027833540" type="tpee.InstanceMethodCallOperation" typeId="tpee.1202948039474" id="4998957681465451680">
              <link role="baseMethodDeclaration" roleId="tpee.1068499141037" targetNodeId="fxg7.~PrintStream%dprintln(java%dlang%dString)%cvoid" resolveInfo="println" />
              <node role="actualArgument" roleId="tpee.1068499141038" type="tpee.StringLiteral" typeId="tpee.1070475926800" id="4998957681465451682">
                <property name="value" nameId="tpee.1070475926801" value="I'm old" />
              </node>
            </node>
          </node>
        </node>
        <node role="statement" roleId="tpee.1068581517665" type="tpee.Statement" typeId="tpee.1068580123157" id="4998957681465451676" />
      </node>
    </node>
  </root>
</model>
